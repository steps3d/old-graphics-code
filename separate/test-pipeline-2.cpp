...
printf ( "%d.%d\n", MajorVersion, MinorVersion );	
	...
	if ( !vp.loadSeparate  ( GL_VERTEX_SHADER, "sep-2-vp.glsl" ) )
		printf ( "Error loadSeparate vp\n" );
	
	p1.setStage ( GL_VERTEX_SHADER_BIT, &vp );

	if ( !fp1.loadSeparate ( GL_FRAGMENT_SHADER, "sep-2-fp1.glsl" ) )
	...
	if ( !fp2.loadSeparate ( GL_FRAGMENT_SHADER, "sep-2-fp2.glsl" ) )
		printf ( "Error loadSeparate fp\n" );
